 ...
 * @LastEditTime: 2020-11-02 11:11:34
 * @FilePath: /cocacola-4/src/components/home.js
 */
					...
					<Col className="col-card">
						<Card className="product-card product-cc">
							...
							<Card.Body className="product-card-body">
								...
								<Button variant="dark" className="button-style" href="/cocacola-4/#/products/coca-cola/explore/">
									EXPLORE
								</Button>
							</Card.Body>
						</Card>
